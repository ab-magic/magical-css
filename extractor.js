...
function extractCssUrls(inputString) {
  ...
  const regex = /<link[^>]*rel=["']stylesheet["'][^>]*href=["']([^"']+)["'][^>]*>|<link[^>]*href=["']([^"']+)["'][^>]*rel=["']stylesheet["'][^>]*>/g;
...
const cssLinksString = `<link rel="stylesheet" href="/_next/static/css/d610b4e67fc083af.css" data-precedence="next"><link rel="stylesheet" href="/_next/static/css/a864441a2f5c643a.css" data-precedence="next"><link rel="stylesheet" href="/_next/static/css/fffb933f2ad15575.css" data-precedence="next"><link rel="stylesheet" href="/_next/static/css/dd901cf4b418ac0f.css" data-precedence="next"><link href="https://fonts.googleapis.com/css?family=Roboto:500" type="text/css" rel="stylesheet">`;
